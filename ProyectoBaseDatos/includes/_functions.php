...
function insertar_productos(){
    ...
    $consulta="INSERT INTO productos (nombre, descripcion, n_serie, categorias, imagen)
    VALUES ('$nombre', '$descripcion', '$color', '$categorias', '$imagenFin');" ;
...
function editar_producto(){
    ...
    $consulta="UPDATE productos SET nombre = '$nombre', descripcion = '$descripcion', n_serie = '$color',  categorias = '$categorias', imagen = '$imagenFin' WHERE id = $id";
